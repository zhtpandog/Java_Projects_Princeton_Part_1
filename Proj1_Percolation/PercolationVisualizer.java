...
public class PercolationVisualizer {
    ...
    public static void main(String[] args) {
    	//File f = new File("/Users/ZhangHaotian/documents/workspace/algorithms_practice/src/algorithms_practice/input6.txt");
    	//boolean ff = f.exists();
    	//System.out.print(ff);
        In in = new In("/Users/ZhangHaotian/documents/workspace/algorithms_practice/src/algorithms_practice/input20.txt");      // input file
